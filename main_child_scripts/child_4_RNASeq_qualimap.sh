...
#SBATCH --mail-user example@whatever.tu-dresden.de	### tell the batch system your email address to get updates about the jobs status
...
./4_RNASeq_qualimap.sh $analysis_dir $bam_files $filename_extention $samplename  
