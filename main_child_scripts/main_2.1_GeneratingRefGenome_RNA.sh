...
sbatch -J 2.1_GeneratingRefGenome $analysis_dir/main_child_scripts/child_2.1_GeneratingRefGenome.sh $analysis_dir $threads $reference_genome38 $reference_gtf $temp_folder
